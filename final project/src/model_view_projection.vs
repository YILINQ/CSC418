...
//                   coordinates
out vec4 pos_cs_in; 
// expects: PI, model, bouncing
void main()
{
  //////////////////////////////////////////////////////

	mat4 shift = translate(vec3(2, 0, 0));
	mat4 models = model(is_moon, is_luna, is_mirana, is_lina, animation_seconds);
//mat4 models = bouncing(is_moon, animation_seconds);
	pos_cs_in = proj * view * models * vec4(pos_vs_in, 1.0);
