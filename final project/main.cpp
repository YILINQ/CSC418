...
Usage:
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    for(int i = 0;i<7;i++)
    {
      ...
      glUniform1i(glGetUniformLocation(prog_id, "is_mirana"), i==2);
      glUniform1i(glGetUniformLocation(prog_id, "is_lina"), i==3);
      glUniform1i(glGetUniformLocation(prog_id, "is_luna"), i==4);
      glUniform1i(glGetUniformLocation(prog_id, "is_lanaya"), i==5);
      glUniform1i(glGetUniformLocation(prog_id, "is_motrai"), i==6);
